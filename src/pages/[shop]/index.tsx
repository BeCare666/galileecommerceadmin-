...
export default function ShopPage() {
  ...
  console.log('cover_image_url', data);
  return (
    <div className="-m-5 md:-m-8">
      ...
      <div className="relative z-10 px-4 lg:px-6 xl:px-10">
        <div className="-mt-16 flex flex-wrap gap-6 lg:-mt-[6.0625rem] 2xl:flex-nowrap">
          <div className="shrink-0">
            <ShopAvatar
              is_active={is_active}
              name={name}
              logo_image_url={logo_image_url as any}
              size="medium"
            />
          </div>
          <div className="flex flex-wrap self-end justify-between w-full 2xl:flex-1">
        ...
        <div className="flex flex-wrap items-stretch gap-4 my-10 lg:gap-6 xl:gap-10">
          <div className="relative w-full shrink-0 overflow-hidden rounded-lg bg-white p-4 lg:w-[18rem] lg:p-6 xl:w-[22.375rem] xl:p-8">
            ...
            {description ? (
              <div className="relative pt-5 mt-5 xl:mt-7 xl:pt-7">
          ...
          {/* Dashboard */}
          <div className="flex-1 w-full p-4 bg-white rounded-lg lg:p-6 xl:p-7 2xl:p-10">
